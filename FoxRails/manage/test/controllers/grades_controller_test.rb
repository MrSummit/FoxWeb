...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { college: @grade.college, grade: @grade.grade, profession: @grade.profession }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { college: @grade.college, grade: @grade.grade, profession: @grade.profession }
    assert_redirected_to grade_path(assigns(:grade))
  end
